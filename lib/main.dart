...
import 'package:final_project/methods/report.dart';
import 'package:final_project/methods/toolBarConfiguration.dart';
import 'package:final_project/methods/user_details_bottom_sheet.dart';
                          ...
                          child: Padding(
                            ...
                            child: QuillEditor(
                              ...
                              configurations: QuillEditorConfigurations(
                                  minHeight: (sectionNumber==0)?20:120, placeholder: (sectionNumber == 0) ? "Type Header Here..." : ""),
                            ),
                          ),
                        ),
                      ),
      ...
      body: Column(
        children: [
          ...
          GestureDetector(
            ...
            onTap: () {
              userDetailsDropDown(context).then((_) {
                setState(() {
                  selectedGender;
                });
              });
